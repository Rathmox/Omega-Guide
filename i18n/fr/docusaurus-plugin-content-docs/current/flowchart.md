...
flowchart TD
    ...
    downgrade_check --Non éligible--> downgrade_fail(( )) --Ouvrir la calculatrice--> hardware_method_n0110[Suivez la méthode hardware]
    ...
    click hardware_method_new_calcs "unlock/hardware/n0110-hardware-unlock"
    click calc_locked_n0110 "what-to-do-locked"
    click calc_unlocked_n0110 "cfw/choose-a-cfw"

    end

    hardware_method_new_calcs([Suivez la méthode hardware])
